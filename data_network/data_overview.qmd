...
## Drug exposure
```{r}
plotTableTrend(record_counts, "drug_exposure")
```

## Condition occurrence
```{r}
plotTableTrend(record_counts, "condition_occurrence")
```

## Measurement
```{r}
plotTableTrend(record_counts, "measurement")
```

## Observation
```{r}
plotTableTrend(record_counts, "observation")
```

## Procedure occurrence
```{r}
plotTableTrend(record_counts, "procedure_occurrence")
```

## Visit occurrence
```{r}
plotTableTrend(record_counts, "visit_occurrence")
```

## Death
```{r}
plotTableTrend(record_counts, "death")
```
